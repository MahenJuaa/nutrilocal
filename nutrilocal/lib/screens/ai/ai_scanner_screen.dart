...
class _AiScannerScreenState extends State<AiScannerScreen>
  ...
  void initState() {
    ...
    // PERBAIKAN ANIMASI: Memulai dari koordinat 20 dan berakhir di 250
    // agar garis pemindai tetap berada di dalam batas gambar
  ...
  Future<void> startScanning() async {
    ...
    setState(() {
      scanningText = 'Detecting Food Object...';
    });
    ...
    setState(() {
      scanningText = 'Matching Nutrition Database...';
    });

    final response = await ApiService.scanFoodImage(
    ...
    if (response.data != null) {
      ...
      setState(() {
        detectedFood = data['name'].toString();
        detectedCalories = (data['calories'] as num).toInt();
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text('AI failed to recognize food'),
        ),
      );
    }
  }
          ...
          children: [
            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // PERBAIKAN EFEK GLOW / LASER PADA GARIS SCANNER
                  if (isScanning)
                    AnimatedBuilder(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  isScanning ? 'Analyzing Food...' : 'Start AI Scan',
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Food added to tracker'),
                            ),
                          );
                        },
                        child: const Text(
